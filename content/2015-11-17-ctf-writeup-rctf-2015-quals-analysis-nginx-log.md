...
The interesting part of each entry basically does this:
```pseudocode
...
So the most interesting entries entries look like this: `...LIMIT 0,1),1,1))!=82),SLEEP(1)...` (highlighted in the snippet).
